...
def convert_messages(
    ...
    if system:
        ...
        agent_suffix = (
            ...
            "\n"
            "\nFORMATTING RULES:"
            "\n- Present ALL information clearly and well-organized."
            "\n- Use clean formatting: headings, bullet points, and tables where appropriate."
            "\n- Do NOT repeat raw tool output verbatim. Instead, parse and reformat it into a readable summary."
            "\n- For search results, extract key info and present as a clean list with brief descriptions."
            "\n- For command output (nvidia-smi, etc.), extract key metrics and present in a structured format."
            "\n- Use plain text formatting. Avoid excessive code blocks for non-code content."
            "\n- Respond in the same language the user used."
            "\n- Remove noise, duplicates, and irrelevant details. Show what matters."
            "\n</CRITICAL INSTRUCTIONS>"
            "\n/no_think"
        )
